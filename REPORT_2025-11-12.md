...
13. Delivered Family Phase B backend: new `familyService`, `/api/relative/list|add|remove`, and `/api/relative/dashboard` now enforce owner/relative permissions (flag `RELATIVE_ENABLED` vẫn mặc định OFF).
