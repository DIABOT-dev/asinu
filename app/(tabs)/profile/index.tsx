...
export default function ProfileScreen() {
  ...
  const healthOverview = useMemo(() => {
    ...
    if (glucoseValue) {
      ...
      else if (glucoseValue > 140 || glucoseValue < 80)
    ...
    <Screen>
      <RippleRefreshScrollView
        ...
        contentContainerStyle={[
          styles.container,
          { paddingTop: padTop, paddingBottom: insets.bottom + 96 },
        ]}
            ...
            <Animated.View entering={FadeIn.delay(0).duration(400)}>
              <View style={styles.profileHeaderCard}>
                ...
                <View style={styles.profileTopRow}>
                  ...
                  <View
                    style={{ flex: 1, marginLeft: spacing.md, minWidth: 0 }}
                  >
                    <Text style={styles.profileGreetingTop}>
                      {t("greeting")}
                    </Text>
                    <Text
                  ...
                  >
                    ...
                    <Text
                      style={[
                        styles.planChipText,
                        subStatus?.isPremium
                          ? styles.planChipTextPremium
                          : styles.planChipTextFree,
                      ]}
                    >
                      {(t("accountType") || "Tài khoản") + ": "}
                ...
                >
                  <View style={{ alignItems: "center", gap: 8 }}>
                    ...
                    >
                      {subStatus?.isPremium
                        ? t("planPremiumDesc") ||
                          "Bạn đang sử dụng đầy đủ tính năng cao cấp"
                        : t("planFreeDesc") ||
                          "Bạn đang dùng bản miễn phí với các tính năng cơ bản"}
                    </Text>
                  </View>
                  ...
                  <View style={{ gap: 8, marginTop: 4 }}>
                    {(subStatus?.isPremium
                      ? [
                          {
                            icon: "check-circle",
                            text: "Vòng kết nối: tối đa 3 người",
                          },
                          {
                            icon: "check-circle",
                            text: "Chat AI Asinu: không giới hạn",
                          },
                          {
                            icon: "check-circle",
                            text: "Lịch sử log: lưu toàn bộ",
                          },
                          {
                            icon: "check-circle",
                            text: "Check-in sức khoẻ hàng ngày",
                          },
                          {
                            icon: "check-circle",
                            text: "Cảnh báo khẩn cấp 115 (SOS)",
                          },
                          {
                            icon: "check-circle",
                            text: "Ghi log đường huyết, huyết áp, cân nặng",
                          },
                        ]
                      : [
                          ...
                          {
                            icon: "check",
                            text: "Chat AI Asinu: 1.000 tin nhắn / tháng",
                          },
                  ...
                  <View style={{ flexDirection: "row", gap: 8, marginTop: 8 }}>
                    ...
                    {!subStatus?.isPremium && (
                      ...
                      >
                        ...
                        >
                          {t("upgradePremium") || "Nâng cấp Premium"}
                        </Text>
                      </Pressable>
                    )}
                  </View>
                    ...
                    items: [
                      {
                        ...
                        color: iconColors.primary,
                        label: ts("helpSupport"),
                        onPress: () =>
                          Linking.openURL("https://zalo.me/0898888917"),
                      },
                      ...(profile?.hasPassword
                        ? [
                            {
                      ...
                      },
                      {
                        ...
                        color: iconColors.primary,
                        label: ts("aiDataConsentSettings"),
                        onPress: () => setShowAiConsentModal(true),
                      },
                      {
                        icon: "shield-checkmark-outline",
                        color: iconColors.emerald,
                        label: ts("privacyPolicy"),
                        onPress: () =>
                          router.push({
                            pathname: "/legal/content",
                            params: { type: "privacy" },
