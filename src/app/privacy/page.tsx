    ...
    <>
      ...
      <LegalContainer>
        ...
        <article className="prose prose-sm max-w-none dark:prose-invert">
          ...
          <p><strong>EN:</strong> ASINU collects and processes data to: (i) log health metrics (blood glucose, weight, blood pressure, meals, water, insulin), (ii) display charts/reports, (iii) send safe reminders, (iv) provide AI-based suggestions (when enabled). The MVP has no in-app payments; subscription clauses apply only when Premium is activated later.</p>
          <p><strong>VI:</strong> ASINU thu thập & xử lý dữ liệu để: (i) ghi log sức khỏe (đường huyết, cân nặng, huyết áp, bữa ăn, nước, insulin), (ii) hiển thị biểu đồ/báo cáo, (iii) gửi nhắc nhở an toàn, (iv) cung cấp gợi ý AI (khi bật). Bản MVP chưa có thanh toán; điều khoản thanh toán chỉ áp dụng khi bật Premium sau này.</p>
          ...
          <p>Qua Cài đặt hoặc email <a className="underline" href="mailto:support@asinu.top">support@asinu.top</a>.</p>
          ...
          <p>Asinu — 12 A, ngách 1/16, Ngõ 1 Thúy Lĩnh, Hà Nội, Việt Nam • Email: support@asinu.top • Phone: +84 898 888 917</p>
        </article>
      </LegalContainer>
    </>
  );
