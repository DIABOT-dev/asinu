...
// Mobile payment routing — app stores cấm dùng QR/wallet ngoài
// platform billing để bán dịch vụ số. 3 mode:
//   'iap'    — native store billing (chuẩn store, đang scaffold)
...
// Product IDs to register on the supported app distribution platforms.
